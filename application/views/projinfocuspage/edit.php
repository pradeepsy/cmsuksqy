								...
								<div class="form-body">									
									...
									<div class="form-group">
										...
										* </span>
										...
										<div class="col-md-4">
											<input type="text" name="venue"  value="<?php if(!empty($data['venue'])) echo $data['venue']; ?>" data-required="1" class="form-control"/>
										</div>
									</div>	
									<div class="form-group">
										...
										* </span>
										...
										<div class="col-md-4">
											<textarea rows="2" name="description" data-required="1" class="form-control"><?php if(!empty($data['description'])) echo $data['description']; ?></textarea>
										</div>
									</div>
									<div class="form-group">
										...
										* </span>
										...
										<div class="col-md-4">
											<select name="region"  class="form-control">
												<?php foreach ($dataregions as $keydata => $valuedata) {
													$region=$data['region'];
												?>
												<option value="<?php if($valuedata) { echo $valuedata['id']; }?>" <?php if($valuedata['id'] == $region) echo "selected";?>><?php if($valuedata) { echo $valuedata['name']; }?></option>
												<?php
												}
												?>
											</select>
