			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					<li>
						...
						<a href="<?php echo base_url();?>index.php/sliders">Menus</a>
				...
				<div class="col-md-12">
					...
					<div class="portlet box green">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>Add Menus
							</div>
						</div>
								...
								<div class="form-body">									
									...
									<div class="form-group">
										...
										* </span>
										...
										<div class="col-md-4">
											<input type="text" name="sequence" value="<?php if(!empty($data['name'])) echo $data['sequence']; ?>" data-required="1" class="form-control"/>
										</div>
									</div>	
									<div class="form-group">
